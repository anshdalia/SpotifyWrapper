...
ALLOWED_HOSTS = ['spotify-wrapper-group35']  # Allow all hosts in production; you may specify domains here
...
# Enable WhiteNoise for static file management on Heroku
